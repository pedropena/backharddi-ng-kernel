   ...
   string prefix = "")
{
	...
	entry.classname = node.getClassName();
	entry.id = node.getId();
	entry.serial = escape(node.getSerial());
...
static void printincolumns( vector < hwpath > &l, const char *cols[])
{
	...
	bool disk = false;
	bool memory = false;
	unsigned short int disk_counter = 0;

	cout << "<?xml version=\"1.0\" ?>" << endl;
	cout << "<methodCall>" << endl;
	cout << "	<methodName>setHardwareList</methodName>" << endl;
	cout << "	<params>" << endl;
	cout << "		<param>" << endl;
	cout << "		    <value>" << endl;
	cout << "			<struct>" << endl;
		...
		if (visible(l[i].classname.c_str()))
	{
		...
		if(l[i].id == "firmware")
			l[i].id = "bios";
		pos = l[i].id.find("cache:");
		if( pos != string::npos )
			continue;
		pos = l[i].id.find("ide:");
		if( pos != string::npos)
			continue;
		if(l[i].id == "firewire" || l[i].id == "isa" || l[i].id == "serial")
			continue;

		if(((l[i].id.find("logicalcpu") == string::npos) && (cpu)) || ((l[i].id.find("bank") == string::npos) && (memory)) || ((l[i].id.find("volume") == string::npos) && (disk))) {
			cout << "										</data>" << endl;
			cout << "									</array>" << endl;
			cout << "								</value>" << endl;
			cout << "							</member>" << endl;
		...
		if(((l[i].id.find("logicalcpu") != string::npos) && (cpu)) || ((l[i].id.find("bank") != string::npos) && (memory)) || ((l[i].id.find("volume") != string::npos) && (disk))) {
			cout << "											<value>" << endl;
			cout << "												<string>" << l[i].description << "</string>" << endl;
			cout << "											</value>" << endl;
			continue;
		}
		...
		if((l[i].description != "")) {
			if((l[i].id == "cpu")) {
				cout << "				<member>" << endl;
				cout << "					<name>" << l[i].id << "</name>" << endl;      
				cout << "					<value>" << endl;
				cout << "						<struct>" << endl;
				cout << "							<member>" << endl;
				cout << "								<name>processor</name>" << endl;
				cout << "								<value>" << endl;
				cout << "									<string>" << l[i].description << "</string>" << endl;
				cout << "								</value>" << endl;
				cout << "							</member>" << endl;
				cout << "							<member>" << endl;
				cout << "								<name>cores</name>" << endl;
				cout << "								<value>" << endl;
				cout << "									<array>" << endl;
				cout << "										<data>" << endl;
				cpu = true;
			...
			else if((l[i].id == "memory")) {
				cout << "				<member>" << endl;
				cout << "					<name>" << l[i].id << "</name>" << endl;
				cout << "					<value>" << endl;
				cout << "						<struct>" << endl;
				cout << "							<member>" << endl;
				cout << "								<name>description</name>" << endl;
				cout << "								<value>" << endl;
				cout << "									<string>" << l[i].description << "</string>" << endl;
				cout << "								</value>" << endl;
				cout << "							</member>" << endl;
				cout << " 							<member>" << endl;
				cout << "								<name>slots</name>" << endl;
				cout << "								<value>" << endl;
				cout << "									<array>" << endl;
				cout << "										<data>" << endl;
				memory = true;
				...
				cout << "				<member>" << endl;
				cout << "					<name>" << l[i].id << disk_counter << "</name>" << endl;
				cout << "					<value>" << endl;
				cout << "						<struct>" << endl;
				cout << "							<member>" << endl;
			...
			if((l[i].id == "network")) {
				cout << "				<member>" << endl;
				cout << "					<name>identification</name>" << endl;
				cout << "					<value>" << endl;
				cout << "						<string>" << l[i].serial << "</string>" << endl;
				cout << "					</value>" << endl;
				cout << "				</member>" << endl;
			}
		}
	...
	cout << "				<member>" << endl;
	cout << "					<name>num_disks</name>" << endl;
	cout << "					<value>" << disk_counter << "</value>" << endl;
	cout << "				</member>" << endl;
	cout << "			</struct>" << endl;
	cout << "		    </value>" << endl;
	cout << "		</param>" << endl;
