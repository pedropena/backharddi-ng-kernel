...
__ID("@(#) $Id: hw.cc 1907 2007-10-13 22:23:16Z lyonel $");
...
string hwNode::asRPCXML(unsigned level)
{
	vector < string > config;
	vector < string > resources;
	ostringstream out;
	...
	if(level == 0) {
		...
		out << "<methodCall>" << endl;
		out << "  <methodName>system.setHardwardList</methodName>" << endl;
		out << "    <params><param>" << endl;
		out << "      <value>" << endl;
		out << "        <array>" << endl;
		out << "           <data>" << endl;
	}
	...
	if(visible(getClassName()))
	{
		...
		out << "                     <value><struct>" << endl;
		out << "                            <member>" << endl;
		out << "                                    <name>id</name>" << endl;
		out << "                                    <value>" << endl;
		out << "                                           <string>" << getId() << "</string>" << endl;
		out << "                                    </value>" << endl;
		out << "                            </member>" << endl;
		out << "                            <member>" << endl;
		out << "                                    <name>class</name>" << endl;
		out << "                                    <value>" << endl;
		out << "                                           <string>" << getClassName() << "</string>" << endl;
		out << "                                    </value>" << endl;
		out << "                            </member>" << endl;
		out << "                            <member>" << endl;
		out << "                                    <name>handle</name>" << endl;
		out << "                                    <value>" << endl;
		out << "                                           <string>" << getHandle() << "</string>" << endl;
		out << "                                    </value>" << endl;
		out << "                            </member>" << endl;
		out << "                            <member>" << endl;
		out << "                                    <name>content</name>" << endl;
		out << "                                    <value><struct>" << endl;

		if(getDescription() != "") {
			out << "                                           <member>" << endl;
			out << "                                                   <name>description</name>" << endl;
			out << "                                                   <value>" << endl;
			out << "                                                          <string>" << escape(getDescription()) << "</string>" << endl;	
			out << "                                                   </value>" << endl;
			out << "                                           </member>" << endl;
		}
		...
		if(getProduct() != "") {
			...
			out << "                                                   <value>" << endl;
			out << "                                                          <string>" << escape(getProduct()) << "</string>" << endl;	
			out << "                                                   </value>" << endl;
			out << "                                           </member>" << endl;
		}
		...
		if(getVendor() != "") {
			out << "                                           <member>" << endl;
			out << "                                                   <name>vendor</name>" << endl;
			out << "                                                   <value>" << endl;
			out << "                                                          <string>" << escape(getVendor()) << "</string>" << endl;	
			out << "                                                   </value>" << endl;
			out << "                                           </member>" << endl;
		}
		...
		if(getPhysId() != "") {
			out << "                                           <member>" << endl;
			out << "                                                   <name>physid</name>" << endl;
			out << "                                                   <value>" << endl;
			out << "                                                          <i4>" << getPhysId() << "</i4>" << endl;	
			out << "                                                   </value>" << endl;
			out << "                                           </member>" << endl;
		}
		...
		if(getBusInfo() != "") {
			out << "                                           <member>" << endl;
			out << "                                                   <name>businfo</name>" << endl;
			out << "                                                   <value>" << endl;
			out << "                                                          <string>" << escape(getBusInfo()) << "</string>" << endl;	
			out << "                                                   </value>" << endl;
			out << "                                           </member>" << endl;
		}
		...
		if(getLogicalName() != "") {
			...
			out << "                                           <member>" << endl;
			out << "                                                   <name>logicalname</name>" << endl;
			out << "                                                   <value><array>" << endl;
			out << "                                                              <data>" << endl;
			
			for(unsigned int i = 0; i < logicalnames.size(); i++) {				
				out << "                                                              <value>" << endl;
				out << "                                                                <string>" << logicalnames[i] << "</string>" << endl;	
				out << "                                                              </value>" << endl;
			}
			
			out << "                                                              </data>" << endl;
			out << "                                                   </array></value>" << endl;
			out << "                                           </member>" << endl;
		}
		
		if(getDev() != "") {
			out << "                                           <member>" << endl;
			out << "                                                   <name>dev</name>" << endl;
			out << "                                                   <value>" << endl;
			out << "                                                          <string>" << escape(getDev()) << "</string>" << endl;	
			out << "                                                   </value>" << endl;
			out << "                                           </member>" << endl;
		}
		...
		if(getVersion() != "") {
			out << "                                           <member>" << endl;
			out << "                                                   <name>version</name>" << endl;
			out << "                                                   <value>" << endl;
			out << "                                                          <string>" << escape(getVersion()) << "</string>" << endl;	
			out << "                                                   </value>" << endl;
			out << "                                           </member>" << endl;
		}
		...
		if(getSerial() != "") {
			out << "                                           <member>" << endl;
			out << "                                                   <name>serial</name>" << endl;
			out << "                                                   <value>" << endl;
			out << "                                                          <string>" << escape(getSerial()) << "</string>" << endl;	
			out << "                                                   </value>" << endl;
			out << "                                           </member>" << endl;
		}
		...
		if(getSlot() != "") {
			out << "                                           <member>" << endl;
			out << "                                                   <name>slot</name>" << endl;
			out << "                                                   <value>" << endl;
			out << "                                                          <string>" << escape(getSlot()) << "</string>" << endl;	
			out << "                                                   </value>" << endl;
			out << "                                           </member>" << endl;
		}
		...
		if(getSize() > 0) {
			...
			out << "                                           <member>" << endl;
			out << "                                                   <name>size</name>" << endl;
			out << "                                                   <value>" << endl;
			out << "                                                          <string>" << getSize() << " " << measure << "</string>" << endl;	
			out << "                                                   </value>" << endl;
			out << "                                           </member>" << endl;
		}
		...
		if(getCapacity() > 0)
		{
			...
			out << "                                           <member>" << endl;
			out << "                                                   <name>capacity</name>" << endl;
			out << "                                                   <value>" << endl;
			out << "                                                          <string>" << getCapacity() << " " << capacity << "</string>" << endl;	
			out << "                                                   </value>" << endl;
			out << "                                           </member>" << endl;
		}
		...
		{			
			out << "                                           <member>" << endl;
			out << "                                                   <name>ancho</name>" << endl;
			out << "                                                   <value>" << endl;
			out << "                                                          <i4>" << getWidth() << "</i4>" << endl;
			out << "                                                   </value>" << endl;
			out << "                                           </member>" << endl;
		}
		...
		{
			out << "                                           <member>" << endl;
			out << "                                                   <name>clock</name>" << endl;
			out << "                                                   <value>" << endl;
			out << "                                                          <i4>" << getClock() << "</i4>" << endl;
			out << "                                                   </value>" << endl;
			out << "                                           </member>" << endl;
		}
		...
		{			
			out << "                                           <member>" << endl;
			out << "                                                   <name>configuration</name>" << endl;
			out << "                                                   <value><array>" << endl;
			out << "                                                             <data>" << endl;
			for (unsigned int j = 0; j < config.size(); j++) {	
				out << "                                                               <value>" << endl;
			
				out << "                                                                   <string>setting id=\"" << escape(config[j]) << "\"</string>" << endl;
		...
		{	
			out << "					   <member>" << endl;
			out << "						<name>capabilities</name>" << endl; 
			out << "						<value><array>" << endl;
			out << "							  <data>" << endl;	
			...
			{	
				out << "								<value>" << endl;
				out << "							            <string>" << escape(getCapabilityDescription(config[j])) << "</string>";
				out << endl;
				out << "								</value>" << endl;
			}
			out << "							  </data>" << endl;
	...
	for (unsigned int i = 0; i < countChildren(); i++)
	{
		if((getChild(i)->getId().find("cache") != string::npos) || (getChild(i)->getId().find("bank") != string::npos) || (getChild(i)->getId().find("usb") != string::npos))
			continue;
		
		out << getChild(i)->asRPCXML(visible(getClassName()) ? level + 1 : 1);
	}
	
	if(level == 0) {
		out << "     </data>" << endl;
		out << "    </array>" << endl;
		out << "    </param></params>" << endl;
		out << "  </methodName>" << endl;
		out << "</methodCall>" << endl;	
	}
